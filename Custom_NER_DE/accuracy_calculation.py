...
def calculate_custom_model_accuracy(data):
    ...
    nlp = load_custom_spacy_model("C:/Users/User/Vincent/Desktop/Jobs/Rise/Task1/Solution/New/v2_Custom_NER_DE") #change directory here to your path for the custom trained model
