...
def generate_prediction_single_text(nlp, text):
    """
...
def generate_prediction_list(nlp, data):
    """
...
model_path = "C:/Users/User/NER/de_spacy_custom"
...
#extracting entities from list - change the path here
df = pd.read_csv('C:/Users/User/NER/03_Protokoll-Zionistenkongress-Basel_1899.txt', delimiter = "\n", header=None, names=["text"])
data = list(df['text'])
